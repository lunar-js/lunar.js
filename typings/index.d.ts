...
export class RestWrapper {
    ...
    public async makeRequest(method: "GET" | "POST" | "PATCH" | "PUT" | "DELETE", path: string, auth?: boolean, versioned?: string, options?: RequestOptions): Promise<Object>;
}
...
export class ClientUser {
    ...
    public async getRelationships(): Object;
    public async getGuildAffinities(): Array<Object>;
    public async getMentions(limit: number, roleMentions: boolean, everyoneMentions: boolean): Object;
    public async removeMention(messageID: Snowflake): Object;
    public async getStickers(): Object;
    public async setEmail(email: string, password: string): Object;
    public async setPassword(newPassword: string, password: string): Object;
}